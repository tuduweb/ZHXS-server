...
class Ctrl{
	 ...
	 */
	routes() {
		this.app.get('/api/questions', this.getAll.bind(this))
		this.app.get('/api/questions/generate', this.generate.bind(this))
		this.app.get('/api/questions/:id', this.get.bind(this))
		this.app.post('/api/questions', this.post.bind(this))
